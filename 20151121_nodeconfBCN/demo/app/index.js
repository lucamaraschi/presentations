...
demo.defineAction$('runner', function runnerHandler(numberOfIterations){
    var num1, num2, tmp;
    num1 = num2 = 1;
...
virgilio.http.get('/demo/run/forrest/:startnumber')
    .addHandler(function wasteSomeTime(req, res, next) {
        setTimeout(function() { next();  }, 500);
    })
    .addHandler(function fibonaccier(req, res){
        var virgilio = this;
